...
%                           to the prior classification which is asssumed
%                           to be more correct.
%                           Default is false.
%
...
%                           you find slight inaccuracy issues or threading
%                           issues on your computer. We found no threading
%                           issues on 3 versions of MATLAB using Windows or
%                           Mac with 2 to 6 cores. What we did find was a
%                           speed consistently better than 250% of our
%                           previous speed in the processing that usually
%                           costs over 50% of UMAP's time when reducing
%                           without templates.
%                           Default is 4.
%
%   EXAMPLES 
