...
if nargout
    ...
    gui_mainfcnJC(gui_State, varargin{:});
end
...
% INPUTFILES.fname
% INPUTFILES{1}
if strfind(varargin{1},'wav')
    INPUTFILES.fname = varargin{1};
else %assume is batch file
    INPUTFILES = lv_readbatch(varargin{1});
end
ChanSpec = '0';
FilterType = 'hanningfirff';
%
...
PlotDataFileStim(hObject,handles);
...
%     if(double(cmd)==29)
%         disp('testtest')
%         NextFileBtn_Callback(hObject, eventdata, handles);
%         
%     end
end
return;
