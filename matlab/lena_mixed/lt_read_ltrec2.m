...
%LENA add 2018/07/25 to deal with empty notegroyups
if ~isfield(RecDatStruct,'NotesInGroup')
    nsize = length(RecDatStruct.CurrNoteGroup);
            [RecDatStruct.NotesInGroup] = deal(repmat(6,1,nsize));
end
